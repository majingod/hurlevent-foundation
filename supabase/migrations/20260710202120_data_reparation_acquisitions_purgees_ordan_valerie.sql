...
-- Ordan Perle noir possede des sorts sans « Acquisition de Sort » ;
-- Valerie Montgomery possede des prieres sans « Acquisition de Priere ».
...
FROM (VALUES
  ('d283bb4e-54be-4915-bcf8-0e5338417a8e'::uuid, 'd9a446cc-abdd-40d1-be68-42240b7c9bae'::uuid), -- Ordan / Acquisition de Sort
  ('4e51752d-ab68-4c26-9ca7-a5f8c7e04566'::uuid, '61eb2c1f-522e-468c-a4ad-f45261e683cc'::uuid)  -- Valerie / Acquisition de Priere
