-- Migration baseline #5 (récupérée depuis schema_migrations le 17 mai 2026 pour F4)
-- Version : 20260421150131
-- Rôle : Refonte RLS authenticated-only sur notifications, personnages, inscriptions
-- et 7 tables liées aux personnages.
