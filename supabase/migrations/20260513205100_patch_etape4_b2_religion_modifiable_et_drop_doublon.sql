-- Partie 1 : Patch attribuer_competences_gratuites_classe (Option B2)
-- Quand type_choix='religion' et un choix est défini, sync personnages.religion_id et est_croyant
...
BEGIN
  ...
  LOOP
    ...
    -- NOUVEAU (B2) : si type_choix='religion' avec un choix défini, sync personnages
...
-- Partie 2 : Drop de l'ancienne signature (doublon)
DROP FUNCTION IF EXISTS public.sauvegarder_etape_4(uuid, uuid);
