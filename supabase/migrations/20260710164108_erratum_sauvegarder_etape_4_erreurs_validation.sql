-- ERRATUM s322 : la migration precedente (fix_choix_gratuites_changement_classe_
-- source_unique_attribuer) a ete appliquee avec une ligne alteree dans le bloc de
-- validation ('erreurs' renvoyait v_validation->'avertissements'). Re-CREATE de la
-- fonction correcte. Idempotent, rejouable a froid.
