-- LOT 2 parité visiteur (audit s311 TOP 5c) : reparations_forge manquait au
-- snapshot → reparation: null pour 100 % des objets forge, bloc réparation
-- invisible à l'Étape 9. Ajout de la table (11 lignes, lisible anon via RLS).
-- Définition complète rejouée (idempotent).
--
