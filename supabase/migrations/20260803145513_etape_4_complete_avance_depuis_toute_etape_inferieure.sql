-- [WIZARD-ETAPES-VERROUILLEES-APRES-GENERATEUR, s373] sauvegarder_etape_4 :
-- en mode COMPLET, l'avancement vers 5 se fait depuis TOUTE etape <= 4 (au lieu
-- de = 4 seul). Motif : le generateur (VIS-8) complete l'etape 4 depuis l'etape 1
-- (etapes 1-3 en brouillon, contrat s365) -> le personnage restait a l'etape 1 et
-- le wizard demeurait entierement verrouille (demande Fred s372). Le flux manuel
-- est inchange : un joueur manuel est toujours exactement a 4 quand il complete
-- l'etape 4 (le stepper l'y oblige). Le brouillon n'avance toujours JAMAIS.
-- SEUL changement : `= 4` -> `<= 4` dans la condition d'avancement.
