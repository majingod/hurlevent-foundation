-- Volet ④ UX-SORTS-PRIERES (s161) : exposer paliers / description_tronc / bonus_niveau
-- dans les vues de la fiche de personnage. Colonnes ajoutées EN FIN (jamais réordonnées).
