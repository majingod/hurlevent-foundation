-- Enrichit l'aperçu (dry-run) de desacheter_competence : chaque item de type
-- 'competence' porte désormais la liste 'niveaux' des niveaux retirés (ex. [2]),
-- pour que la modale puisse afficher « Alchimie (niv 2) ». Aucune logique de
-- cascade/mutation modifiée. Signature identique -> CREATE OR REPLACE (pas de surcharge).
