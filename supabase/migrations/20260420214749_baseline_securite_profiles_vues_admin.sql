-- Migration baseline #2 (récupérée depuis schema_migrations le 17 mai 2026 pour F4)
-- Version : 20260420214749
-- Rôle : Sécuriser les profils contre l'usurpation et l'élévation de privilèges,
-- créer la RPC get_joueurs_avec_count et les vues administratives sécurisées.
