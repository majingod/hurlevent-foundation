...
const JALONS: Jalon[] = [
  ...
  // ===== Fait — Août 2026 =====
  {
    statut: "fait",
    periode: "Août 2026",
    titre: "Tes réponses de la boussole ne s'effacent plus en quittant l'écran",
    description:
      "Dans « Guide-moi », quitter l'écran — pour revenir aux trois chemins ou consulter autre chose — effaçait tout ce que tu avais posé. Maintenant ton équipement coché, ta race retenue et tes grandes lignes te retrouvent quand tu reviens, tant que l'onglet reste ouvert. Tout reste sur ton appareil : rien n'est envoyé au serveur.",
  },
